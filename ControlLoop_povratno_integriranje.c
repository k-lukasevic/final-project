...
// Razlika veličina prije i nakon saturacije (mdiff) dovodi se u sumu s regulacijskim odstupanjima i takva suma ulazi u integrator
// Suma reg.odstupanja i mdiff smanjuje veličinu koja ulazi u integrator jer ce mdiff biti negativan kad se nalazimo u zasićenju [ mdiff = m_saturiran - m ]
...
void ControlLoop ( void )
{
    ...
    // provjera uvjeta za antiwind-up uvjetno integriranje
